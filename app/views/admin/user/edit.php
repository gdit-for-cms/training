            ...
            <div class="card-body">
                <form id='form_update_user' class="" action="update" method="PUT">
                    <div class="mb-3">
                        ...
                        <span class="text-xs d-block text-gray-400">Name must have a minimum of 5 characters, a maximum
                            of 50 characters, must not have a leading and trailing space and cannot have two consecutive
                            spaces.</span>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="gender" name="gender" data-gender="<?php echo $user['gender'] ?>"
                            class="form-control">
                    ...
                    <div class="row mb-3">
                        <div class=" col-md-6">
                            ...
                            <span class="text-xs d-block text-gray-400">Your password must be at least 8 characters
                                long, contain at least one number and have a mixture of uppercase and lowercase
                                letters.</span>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="room" name="room_id" class="form-control">
                                ...
                                <option <?php if ($user['room_id'] == $room['id']) {
                                                echo 'Selected';
                                            } else {
                                                '';
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="position" name="position_id" class="form-control">
                                ...
                                <option <?php if ($user['position_id'] == $position['id']) {
                                                echo 'Selected';
                                            } else {
                                                '';
