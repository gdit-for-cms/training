            ...
            <div class="card-body">
                <form id="form_new_position" class="" action="create" method="POST">
                    <div class="mb-3">
                        ...
                        <input class="form-control" rows="3" name="title" id="description" placeholder="Title..." />
                    </div>
                    <div class="mb-3">
                        <label for="note" class="form-label">Question*</label>
                        <textarea id="editor-edit-note" class="form-control h-120px" name="content" id="note" rows="3"><?php  ?></textarea>
                    </div>
                    <div class="mb-3">
