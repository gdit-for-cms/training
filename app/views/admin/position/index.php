<!-- <div class="container-fluid p-0 ">
    <div class="row">
        <div class="col-12"> -->
            <div id="position" name="position" class="mt-6 nav_content ">
                        ...
                        <?php foreach ($positions as $position) { ?>
                            <div class="panel panel-default">
                                <div class="panel-heading flex justify-between items-center">
                                    <span class="position_name_main text-xl font-bold bg-white p-2 rounded-lg"><?= $position['name'] ?></span>
