                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm flex justify-center items-center">
                                ...
                                <div class="w-10 h-auto cursor-pointer">
                                    <img src="https://img.vietqr.io/image/<?php echo $bank_bin ?>-<?php echo $bank_acc ?>-compact2.png?amount=<?php echo $debtor_unpaid["total"] ?>&addInfo=<?php echo $current_user['display_name'] . " GDIT tra no" ?>" alt="QR Code" onclick="openModal(this.src)" onerror="this.onerror=null; this.src='<?php echo '/img/no_QR_code.png'; ?>';">
                                </div>
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm ">
                                <div class="flex items-center justify-center">
